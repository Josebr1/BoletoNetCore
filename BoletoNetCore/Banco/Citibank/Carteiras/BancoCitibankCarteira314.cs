...
{
    [CarteiraCodigo("2", "02", "002", "314")]
    public class BancoCitibankCarteira314 : ICarteira<BancoCitibank>
    {
        internal static Lazy<ICarteira<BancoCitibank>> Instance { get; } = new Lazy<ICarteira<BancoCitibank>>(() => new BancoCitibankCarteira314());

        private BancoCitibankCarteira314()
        {
        ...
        public string FormataCodigoBarraCampoLivre(Boleto boleto)
        {
            ...
            var portifolio = "314"; //CodigoConvenioBanco.Substring(17, 3);
